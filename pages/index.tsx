...
export default function Home() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="my-12">
        <p className="mb-6 font-bold">Tye your prompt</p>
        <input 
          placeholder="Type here" 
          className="w-full max-w-xs input input-border input-secondary" 
          value={value} 
        ...
        <button 
          ...
          onClick={handleRefresh}>Start New Conversation</button>
      </div>
      ...
      <React.Fragment key={index}>
        ...
        <div className="chat chat-end">
          <div className="chat-bubble chat-bubble-secondary">
            <strong className="badge badge-primary">Ilana</strong>
            <br />
            {item.content}
          </div>
        </div>
